...
public class shoppingCartControllerViewRest {
  ...
  public ResponseEntity<Void> deleteProductShoppingCarts(@PathVariable int idClient, @PathVariable int idProduct) {

    return ResponseEntity.ok(shoppingCartService.deleteProductShoppingCarts(idClient, idProduct));

  }

  @DeleteMapping("/client/{idClient}")
  public ResponseEntity<Void> deleteShoppingCarts(@PathVariable int idClient) {
    System.out.println("idClient:" + idClient);
    return ResponseEntity.ok(shoppingCartService.deleteShoppingCartsClient(idClient));

  }

  @GetMapping("/shop")
  public void shopE() {
    System.out.println(shoppingCartService.shopCart(26));
  }
