...
@WebServlet("/getDataControlLogin")
public class GetDataControlLogin extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    oneJson.put("data", "login");
    oneJson.put("error", ErrorResponse.DATACONTROL);

    try {
      oneJson.put("datos", caller.getUserLogin((int) RequestContextHolder.currentRequestAttributes()
    ...
    System.out.println("GetDataLogin: " + response);
